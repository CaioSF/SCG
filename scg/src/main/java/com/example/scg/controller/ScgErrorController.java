...
import com.example.scg.dominio.ErrorJSON;
...
@RestController
public class ScgErrorController implements ErrorController {

    @Autowired
    private ErrorAttributes errorAttributes;

    @RequestMapping(value = "/error" )
    public ErrorJSON onJSON(HttpServletRequest request, HttpServletResponse response) {
